      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        >
          ...
          <div class="flex items-start gap-4">
            <div
              class="w-12 h-12 rounded-lg flex items-center justify-center shrink-0 surface-muted text-2xl"
              :style="{ background: h.brandColor }"
            >
              <span class="text-white font-bold">{{ h.glyph }}</span>
            </div>
...
const hypervisors = [
  { id: 'proxmox',    labelKey: 'onboarding.hypervisorStep.proxmox',    subtitle: 'Proxmox VE 8.x and 9.x', glyph: 'P', brandColor: '#e57000', enabled: true  },
  { id: 'vsphere',    labelKey: 'onboarding.hypervisorStep.vsphere',    subtitle: 'VMware ESXi / vSphere',  glyph: 'V', brandColor: '#717074', enabled: false },
  { id: 'hyperv',     labelKey: 'onboarding.hypervisorStep.hyperv',     subtitle: 'Microsoft Hyper-V',      glyph: 'H', brandColor: '#0078d4', enabled: false },
  { id: 'azureLocal', labelKey: 'onboarding.hypervisorStep.azureLocal', subtitle: 'Azure Stack HCI',        glyph: 'A', brandColor: '#0078d4', enabled: false },
]
